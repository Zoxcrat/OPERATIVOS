...
void pedir_contexto_a_memoria()
{
    while (1)
    {
        ...
        log_info(logger_obligatorio, "“## <%d>: <%d> - Solicito Contexto Ejecución", pid_actual, tid_actual);
...
op_code string_a_instruccion(char *str)
{
    if (strcmp(str, "SET") == 0)
        return SET;
    if (strcmp(str, "READ_MEM") == 0)
        return READ_MEM;
    if (strcmp(str, "WRITE_MEM") == 0)
        return WRITE_MEM;
    if (strcmp(str, "SUM") == 0)
        return SUM;
    if (strcmp(str, "SUB") == 0)
    ...
    if (strcmp(str, "LOG") == 0)
        return LOG;
    if (strcmp(str, "PROCESS_CREATE") == 0)
        return PROCESS_CREATE;
    if (strcmp(str, "PROCESS_EXIT") == 0)
        return PROCESS_EXIT;
    if (strcmp(str, "THREAD_CREATE") == 0)
        return THREAD_CREATE;
    if (strcmp(str, "THREAD_JOIN") == 0)
        return THREAD_JOIN;
    if (strcmp(str, "THREAD_CANCEL") == 0)
        return THREAD_CANCEL;
    if (strcmp(str, "THREAD_EXIT") == 0)
        return THREAD_EXIT;
    if (strcmp(str, "MUTEX_CREATE") == 0)
        return MUTEX_CREATE;
    if (strcmp(str, "MUTEX_LOCK") == 0)
        return MUTEX_LOCK;
    if (strcmp(str, "MUTEX_UNLOCK") == 0)
        return MUTEX_UNLOCK;
